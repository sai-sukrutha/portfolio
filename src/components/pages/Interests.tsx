  ...
  return (
    <div>
        ...
        <div className='topic-para'>
            ...
            <a href="https://www.instagram.com/sai_sukrutha/" target='_blank'><PiInstagramLogoBold/>Instgram: sai_sukrutha</a>
            <a href="https://www.youtube.com/@sukruthascraftube" target='_blank'><PiYoutubeLogoBold/>Youtube: Sukrutha's CrafTube</a>
            <br/>
            <br/>
