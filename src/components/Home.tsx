            ...
            <div className="content">
                <div className='topic-para' >
                    ...
                    <div className="contact-logos">
                        ...
                        <a className="contact-item only-icon" href="https://github.com/sai-sukrutha" target='_blank'><PiLinkedinLogoBold/></a>
                        <a className="contact-item only-icon" href="https://www.linkedin.com/in/sai-sukrutha-chamakoora-375018191/" target='_blank'><PiGithubLogoBold/></a>
                    </div>
                </div>
